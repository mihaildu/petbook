...
function attempt_signup(signup_data, ee, args){
     ...
     *
     * TODO update this (firstName + etc)
     * ret: {
     *   "success": ..., (true/false)
	...
	check_email(signup_data, model, signup_emitter, "email");
    });
	...
	/* add user to db */
	signup(signup_data, model, signup_emitter, "signup");
    });
...
function check_email(signup_data, model, ee, event){
    /*
...
function signup(signup_data, model, ee, event, args){
    /*
